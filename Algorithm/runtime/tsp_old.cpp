...
// Problem and answer from https://www.youtube.com/watch?v=1FEP_sNb62k
//
...
//    dist = readTSPFile("/Users/ryuci/Dropbox/workspace/cpp/Algorithm/Algorithm/usca312_dist.txt", 312);
    numCities = 30;
    dist = readTSPFile("/Users/ryuci/Dropbox/workspace/cpp/Algorithm/Algorithm/ha30_dist.txt", 30);
    path.clear();
    path.push_back(0);
    visited = std::vector<bool>(numCities, false);
    visited[0] = true;
